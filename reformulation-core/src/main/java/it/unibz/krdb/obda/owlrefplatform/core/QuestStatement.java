...
public class QuestStatement implements OBDAStatement {
    ...
    private class QueryExecutionThread extends Thread {
        ...
        private final SesameConstructTemplate templ;

        // only for CONSTRUCT and DESCRIBE queries
        private TupleResultSet tupleResult;

        // only for SELECT and ASK queries
            ...
            try {
                ...
                if (sql.equals("")) {
                    ...
                    try {
                        ...
                        if (exceptionClassName.equals(MySQLTimeoutExceptionClassName) || exceptionClassName.equals(PSQLExceptionClassName)) {
                            log.warn("SQL execution is time out");
                        } else {
                            exception = e;
                        ...
                        if (SPARQLQueryUtility.isDescribeQuery(pq)) {
                            ...
                            if (SPARQLQueryUtility.isVarDescribe(strquery)) {
                                ...
                                if (resultSet instanceof EmptyTupleResultSet) {
                                    ...
                                    if (resultSet instanceof QuestTupleResultSet) {
                                ...
                                if (SPARQLQueryUtility.isURIDescribe(strquery)) {
                                    try {
